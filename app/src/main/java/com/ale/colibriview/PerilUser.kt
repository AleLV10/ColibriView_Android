...
class PerilUser : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.mnuBarraUsuario.menutest.setOnClickListener {
            // Do something in response to button click
            val intent = Intent(this, CardsTest::class.java)
            startActivity(intent)
            finish()
        }
        ...
        binding.mnuBarraUsuario.usuario.setOnClickListener {
            // Do something in response to button click
            val intent = Intent(this,PerilUser::class.java)
            startActivity(intent)
            finish()
        }
        ...
        binding.guardarCambios.setOnClickListener {
            if(binding.perfilName.isEnabled)
                updateProfile()
            if(binding.perfilCorreo.isEnabled)
                updateEmail()
            if(binding.imgOjo.isEnabled)
                updateProfile()
            binding.perfilName.isEnabled = false
            binding.perfilCorreo.isEnabled=false
            binding.guardarCambios.isEnabled=false
    ...
    private fun parseResult(resultCode: Int, intent: Intent?): Uri? {
